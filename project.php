...
$query_comments = "SELECT c.contenu, u.nom, u.prenom FROM Commentaire c JOIN Commentaire_Projet cp ON c.id_commentaire = cp.id_commentaire JOIN Utilisateur u ON c.id_utilisateur = u.id_utilisateur WHERE cp.id_projet = '$project_id'";
...
$query_budget = "SELECT b.montant, b.date_allocation, b.etat FROM Budget b WHERE b.id_projet='$project_id' LIMIT 1";
...
<body>
    ...
    <div class="container mt-5">
        <h2 class="text-center"><?php echo $project['titre']; ?></h2>
        ...
        <ul class="list-group">
            <?php while ($comment = mysqli_fetch_assoc($result_comments)): ?>
                <li class="list-group-item">
                    <strong><?php echo $comment['prenom'] . ' ' . $comment['nom']; ?>:</strong> <?php echo $comment['contenu']; ?>
                </li>
            <?php endwhile; ?>
        </ul>
        ...
        <ul class="list-group">
            <?php while ($document = mysqli_fetch_assoc($result_documents)): ?>
                <li class="list-group-item">
                    <a href="<?php echo $document['chemin_acces']; ?>" target="_blank"><?php echo $document['nom']; ?></a>
                </li>
            <?php endwhile; ?>
        </ul>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($budget['etat'] != 'Validé'): ?>
                                <a href="validate_budget.php?id=<?php echo $project_id; ?>" class="btn btn-success">Valider</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                </tbody>
        ...
        <?php if ($role == 'chef_de_projet'): ?>
            ...
            <a href="delete_project.php?id=<?php echo $project_id; ?>" class="btn btn-danger">Supprimer le Projet</a>
        <?php endif; ?>
    </div>
</body>
</html>
